...
ft_transcendence is a web application designed to facilitate online multiplayer gaming and communication features.
The primary focus of the project is to enable users to engage in real-time Pong matches while also providing a robust chat system for communication among users.
...
**2-** Install dependencies for both the backend (NestJS) and frontend (ReactJS).

**3-** Run the project using **make build**.

**4-** Access the application via the specified URL and start exploring its features.
